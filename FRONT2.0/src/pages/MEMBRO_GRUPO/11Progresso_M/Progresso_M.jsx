  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      >
        ...
        <Menu_Superior backgroundColor="#someColor"  profileRoute="/Perfil_M" interfaceType="Membro_Grupo" />
        ...
        <Grid container spacing={1} direction="column">
          <Grid item>
            <EtapaButton icon={DescriptionIcon} label="DOCUMENTAÇÃO"  to="/Documentacao_M"/>
          </Grid>
          <Grid item>
            <EtapaButton icon={PersonIcon} label="APRESENTAÇÃO" to="/Apresentacao_M" />
          </Grid>
          <Grid item>
            <EtapaButton icon={EmojiEventsSharpIcon} label="PROJETO" to="/Projeto_M" />
          </Grid>
        </Grid>
        <Box mt={3} mb={7}> 
          <Typography 
