  ...
  const menuItems = [
    {
      ...
      text: "Tarefas",
      path: "/Central_Tarefas_M" // Define o caminho para a página de Tarefas
    },
    {
    ...
    },
    {
      ...
      text: "Modelo",
      path: "/Modelo_M" // Define o caminho para a página de Modelo
    },
    {
      icon: selectedIndex === 4 ? <SettingsIcon sx={{ color: '#07382E' }} /> : <SettingsOutlinedIcon />,
      text: "Configurações",
      path: "/Config_M" // Define o caminho para a página de Configurações
    }
  ];
